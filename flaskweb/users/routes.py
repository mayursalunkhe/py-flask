...
from flaskweb.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                  RequestResetForm, ResetPasswordForm)
from flaskweb.users.utils import save_picture, send_reset_email
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Email feature is disabled for some time, try again later.', 'info')
